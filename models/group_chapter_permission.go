...
type GroupChapterPermission struct {
	...
	ChapterID       string        `gorm:"column:chapter_id;type:varchar(36);primaryKey;not null"`
	...
	TimeStart       *time.Time    `gorm:"column:time_start;type:time"`
	TimeEnd         *time.Time    `gorm:"column:time_end;type:time"`
